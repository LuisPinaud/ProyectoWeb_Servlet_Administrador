				...
				<div class="row">
					...
					<div
						...
						<form action="CategoriasServlet?type=edit" method="post"
							...
							<%Categorias categoria = (Categorias) request.getAttribute("categoriaData"); %>
							<div class="form-group">
								<label>ID:</label> <input class="form-control" type="text"
									name="txtID" value="<%=(categoria != null) ? categoria.getIDCategoria() : ""%>" readonly>
							</div>
							<div class="form-group">
								<label>Nombre:</label> <input class="form-control" type="text"
									name="txtNomCategoria" id="txtNomCategoria" value="<%=(categoria != null) ? categoria.getNombreCategoria() : ""%>">
							</div>
							<button type="button" class="btn btn-warning" onclick="window.location.href = 'CategoriasServlet?type=list';">Regresar</button>
						...
						<script>
							function validarFormulario() {
								var nombre = document
										.getElementById('txtNomCategoria').value
										.trim();
